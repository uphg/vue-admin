...
declare global {
  ...
  const APP_LOCAL_CACHE_KEY: typeof import('./shared/common')['APP_LOCAL_CACHE_KEY']
  const APP_TOKEN_CACHE_KEY: typeof import('./shared/common')['APP_TOKEN_CACHE_KEY']
  ...
  const merge: typeof import('./shared/lodash')['merge']
